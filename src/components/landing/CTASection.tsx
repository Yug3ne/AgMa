  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-brand rounded-3xl px-8 py-16 md:px-16 md:py-20 text-center">
          {/* Main Heading */}
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-brand/20 mb-8 max-w-4xl mx-auto leading-relaxed">
